 ...
 */
public class FmrNewTimeLine extends javax.swing.JDialog {
    private static FmrWorkspace frame ;
    private static Indicador indicador = new Indicador();
     ...
     * @param frame
     */
    public FmrNewTimeLine(java.awt.Frame parent, boolean modal,FmrWorkspace frame, DefaultMutableTreeNode selectedNode, Indicador indicador) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Linha do Tempo");
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
            indicador.setNomeTimeLine("x" + Utils.removerAcentosEspacos(image.getFileImagem().getName()));
            indicador.setCaminhoTimeLine(image.getCaminho());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FmrNewTimeLine dialog = new FmrNewTimeLine(new javax.swing.JFrame(), true, frame, selectedNode, indicador);
